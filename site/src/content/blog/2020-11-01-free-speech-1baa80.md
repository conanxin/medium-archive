---
title: "副标题：改变互联网的经济和数字基础设施，以促进言论自由（free speech）"
...
::: {#0e49 .section .section .section--body .section--first .section--last}
::: section-divider
...
### 协议，而不是平台：言论自由的技术途径 {#4732 .graf .graf--h3 .graf--leading .graf--title name="4732"}

副标题：改变互联网的经济和数字基础设施，以促进言论自由（free speech）

原文：[Protocols, Not Platforms: A Technological Approach to Free Speech](https://link.zhihu.com/?target=https%3A//knightcolumbia.org/content/protocols-not-platforms-a-technological-approach-to-free-speech){.markup--anchor .markup--p-anchor data-href="https://link.zhihu.com/?target=https%3A//knightcolumbia.org/content/protocols-not-platforms-a-technological-approach-to-free-speech" rel="nofollow noreferrer noopener" target="_blank"} （2019）
...
### 早期的协议问题以及平台做得好的地方 {#fb09 .graf .graf--h3 .graf-after--p name="fb09"}
...
### 大平台当前面临的问题 {#0620 .graf .graf--h3 .graf-after--p name="0620"}
...
### 营救协议 {#d787 .graf .graf--h3 .graf-after--p name="d787"}
...
此外，它还使竞争环境更加开放。尽管Gmail是一个特别受欢迎的电子邮件服务，其他公司也能够建立起重要的电子邮件服务，如[http://Outlook.com](https://link.zhihu.com/?target=http%3A//Outlook.com){.markup--anchor .markup--p-anchor data-href="https://link.zhihu.com/?target=http%3A//Outlook.com" rel="nofollow noreferrer noopener" target="_blank"}或雅虎邮件，或者创建针对不同市场和生态的成功的初创电子邮件服务，如Zohomail或Protonmail。这也打开了其他服务的大门，可以在现有的电子邮件生态系统之上进行构建，而不必担心依赖单一平台会将其拒之门外。例如，Twitter和Facebook都有转换产品方向和切断第三方应用的倾向，但在电子邮件领域，有一个蓬勃发展的服务和公司市场，如Boomerang、SaneBox和MixMax，每个公司都提供额外的服务，可以在各种不同的电子邮件平台上运行。

最终结果是，无论是在电子邮件服务之间，还是在电子邮件服务之内，为了使服务更好，竞争更加激烈，同时，主要服务提供商的行为也更符合用户的最大利益，因为大幅降低的锁定程度让这些用户可以选择离开。

### 保护言论自由，但限制滥用行为的影响 {#64ae .graf .graf--h3 .graf-after--p name="64ae"}
...
### 保护用户数据和隐私 {#e9e4 .graf .graf--h3 .graf-after--p name="e9e4"}
...
### 实现更大的创新 {#ada6 .graf .graf--h3 .graf-after--p name="ada6"}
...
### 创造新的商业模式 {#1b72 .graf .graf--h3 .graf-after--p name="1b72"}
...
### 哪些地方可能不适用 {#fa30 .graf .graf--h3 .graf-after--p name="fa30"}
...
### 行动中的例子/实践中的情况 {#3aab .graf .graf--h3 .graf-after--p name="3aab"}
...
### 结论 {#d49c .graf .graf--h3 .graf-after--p name="d49c"}
...
[泰德·尼尔森：《极客们带来的礼物：计算机世界是如何发展到今天的》](https://zhuanlan.zhihu.com/p/102268982){.markup--anchor .markup--p-anchor data-href="https://zhuanlan.zhihu.com/p/102268982" rel="noopener" target="_blank"}

[米奇·卡普尔（Mitch Kapor）：文明的网络空间（《滚石》杂志，1993年）](https://zhuanlan.zhihu.com/p/100028097){.markup--anchor .markup--p-anchor data-href="https://zhuanlan.zhihu.com/p/100028097" rel="noopener" target="_blank"}
